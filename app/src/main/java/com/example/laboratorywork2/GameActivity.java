...
public class GameActivity extends AppCompatActivity implements Observer, Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGridSize = Utility.gridSizes.get(gridSize);
        mTimer = Utility.timers.get(timer);
        mRangeBegin = Utility.frameRates.get(frameRates).range_begin;
        mRangeEnd = Utility.frameRates.get(frameRates).range_end;
