...
public class SecondFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mGridSize = Utility.gridSizes.get(getArguments().getString(ARG_PARAM1));
            mTimer = Utility.timers.get(getArguments().getString(ARG_PARAM2));
            mRangeBegin = Utility.frameRates.get(getArguments().getString(ARG_PARAM3)).range_begin;
            mRangeEnd = Utility.frameRates.get(getArguments().getString(ARG_PARAM3)).range_end;
        }
    }
