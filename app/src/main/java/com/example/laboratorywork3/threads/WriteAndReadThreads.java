package com.example.laboratorywork3.threads;

import static android.content.Context.MODE_PRIVATE;

import android.app.Activity;
import android.content.SharedPreferences;
import com.example.laboratorywork3.observer.Observable;
import com.example.laboratorywork3.observer.Observer;

import java.util.Objects;

public class WriteAndReadThreads extends Thread implements Observable {
